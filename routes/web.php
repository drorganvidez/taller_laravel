...
Route::group(['prefix' => '{instance}', 'middleware' => ['checkblock']], function(){
    ...
    Route::prefix('note')->group(function () {
        Route::get('list', [NoteController::class, 'list'])->name('note.list');
        Route::get('view/{id}', [NoteController::class, 'view'])->name('note.view');
        Route::get('create', [NoteController::class, 'create'])->name('note.create');
        Route::post('create_p', [NoteController::class, 'create_p'])->name('note.create_p');
        Route::get('edit/{id}', [NoteController::class, 'edit'])->name('note.edit');
        Route::post('edit_p', [NoteController::class, 'edit_p'])->name('note.edit_p');
        Route::post('remove', [NoteController::class, 'remove'])->name('note.remove');
    });
